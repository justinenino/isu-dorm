...
DELIMITER ;;
CREATE PROCEDURE `ArchiveOldAnnouncements`()
BEGIN
...
/*!50003 SET collation_connection  = cp850_general_ci */ ;
DELIMITER ;;
CREATE PROCEDURE `UpdateAnnouncementLikeCount`(IN announcement_id INT)
BEGIN
    UPDATE announcements 
    SET like_count = (
        SELECT COUNT(*) 
...
/*!50003 SET collation_connection  = cp850_general_ci */ ;
DELIMITER ;;
CREATE PROCEDURE `UpdateAnnouncementViewCount`(IN announcement_id INT)
BEGIN
    UPDATE announcements 
