<?php
/**
 * Gmail SMTP Email Configuration for Dormitory Management System
 * 
 * This file handles email notifications using Gmail SMTP
...
define('EMAIL_SMTP_USERNAME', 'dormitoryisue2025@gmail.com'); // Gmail address
...
define('EMAIL_FROM_EMAIL', 'dormitoryisue2025@gmail.com'); // Gmail address
define('EMAIL_REPLY_TO', 'dormitoryisue2025@gmail.com');

/**
 * Send email using Gmail SMTP with cURL
 * 
...
function sendEmail($to, $subject, $body, $alt_body = '') {
    ...
    try {
        ...
        // Use Gmail SMTP with cURL
        return sendEmailViaGmail($to, $subject, $email_body, implode("\r\n", $headers));
...
function sendEmailViaGmail($to, $subject, $body, $headers) {
    // For Gmail SMTP, we'll use a simple approach with mail() function
    // but with proper headers for better delivery
